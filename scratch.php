...
if(isset($_POST['submit'])){
  ...
  $sql = "INSERT INTO orders (customer_id, coffee_flavor, coffee_quantity, dessert_flavor, dessert_quantity, date_of_transac) 
          VALUES (:customer_id, :coffee_flavor, :coffee_quantity, :dessert_flavor, :dessert_quantity, CURRENT_DATE)";
  $stmt = $conn->prepare($sql);
  
  // Bind parameters and execute the statement
  $stmt->bindParam(':customer_id', $customer_id);
  $stmt->bindParam(':coffee_flavor', $coffee_flavor);
  $stmt->bindParam(':coffee_quantity', $coffee_quantity);
  $stmt->bindParam(':dessert_flavor', $dessert_flavor);
  $stmt->bindParam(':dessert_quantity', $dessert_quantity);
